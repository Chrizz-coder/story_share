 ...
 * To re-enable: uncomment all code below, remove the block comment delimiters,
 * and import this component in app/(landing)/page.tsx.
 *
 * 'use client';
...
// Pricing is temporarily disabled — export a no-op to avoid broken imports if referenced elsewhere
export default function Pricing(_props: { onSelectPlan?: (plan: string) => void }) {
  return null;
}
